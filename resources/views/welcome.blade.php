            ...
            <div class="modal-body p-0">
                <div class="container-fluid">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-8">
                            <form class="p-lg-5 col-12 row g-3" action="{{ route('sendcontact') }}" method="POST">
                                @csrf
                                @method('POST')
                                <div>
                                    <h1>Get in touch</h1>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="fname" class="form-control" placeholder="Jon" id="fname"
                                           aria-describedby="emailHelp">
                                </div>
                                <div class="col-lg-6">
                                    <label for="lname" class="form-label">Last name</label>
                                    <input type="text" name="lname" class="form-control" placeholder="Doe" id="lname"
                                           aria-describedby="emailHelp">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="message" id="message" placeholder="This is looking great and nice."
